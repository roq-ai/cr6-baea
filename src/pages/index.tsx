  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to CR6 - Your Ultimate Talent Interviewing Platform. Leveraging MySQL, NodeJS, ExpressJS, and ReactJS to revolutionize your recruitment process."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1521791136064-7986c2920216?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZWNydWl0bWVudHxlbnwwfHx8fDE2OTA3MDc2NDd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to CR6 - Your Ultimate Talent Interviewing Platform. Leveraging MySQL, NodeJS, ExpressJS, and ReactJS to revolutionize your recruitment process.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                ...
                <Card userTypeName="Candidate" type="candidate" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
